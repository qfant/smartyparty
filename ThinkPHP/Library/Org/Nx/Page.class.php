...
class Page{
    ...
    public function show() {
        ...
        $action=str_replace('/index.php', '', __ACTION__);
        $this->url = U($action, $this->parameter);
        /* 计算分页信息 */
        ...
        $test=array($this->config['header'], $this->nowPage, $up_page, $down_page, $the_first, $link_page, $the_end, $this->totalRows, $this->totalPages);
        //替换分页内容
