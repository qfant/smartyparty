...
php;
    ...
    public function _validate(){
        $str=<<<php
<script src="__PUBLIC__/statics/validate/jquery.validate.js"></script>    
<script src="__PUBLIC__/statics/validate/jquery.validate.extend.js"></script>    
<script src="__PUBLIC__/statics/validate/additional-methods.js"></script>    
<script src="__PUBLIC__/statics/validate/messages_zh.js"></script>    
php;
        return $str;
    }
    /**
     * highcharts
     */
    public function _highcharts(){
        $str=<<<php
<script src="__PUBLIC__/statics/highcharts/highcharts.js"></script>    
php;
        return $str;
    }
    /**
