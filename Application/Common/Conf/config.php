...
return array(
//*************************************附加设置***********************************
    'GLOBAL_PIC_URL'        => 'http://sm.qfant.com',                           // 是否显示调试面板
    'GLOBAL_DOMAIN_URL'        => 'http://sm.qfant.com',                           // 是否显示调试面板
    ...
    'TMPL_PARSE_STRING'      => array(                           // 定义常用路径
        ...
        '__ADMIN_CSS__'      => OSS_URL.__ROOT__.'/Public/statics/css',
...
//***********************************其他设置**********************************
    ...
    'GEETEST_ID'             => 'ed941199884ea946efbb0f32325b86a6',//极验id  仅供测试使用
    'GEETEST_KEY'            => '6889de179128fd7e39868545cae146b5',//极验key 仅供测试使用
...
//***********************************缓存设置**********************************
	...
	'UPDATE_INFO'       => array(
        'upgradeAddress'              => array(array('source'=>"官网","url"=>'http://sm.qfant.com/smarty.apk')), 
        'upgradeNote'              => "修改利辛县积分小数点查询bug",
        'force'              =>false,
        'versionCode'              => 2, 
        'nversion'              => '2.0.0', 
    )
