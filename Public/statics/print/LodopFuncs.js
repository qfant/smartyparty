function getLodop(oOBJECT,oEMBED,root){
/**************************
  本函数根据浏览器类型决定采用哪个对象作为控件实例：
  IE系列、IE内核系列的浏览器采用oOBJECT，
  其它浏览器(Firefox系列、Chrome系列、Opera系列、Safari系列等)采用oEMBED。
**************************/
		var http=root+"js/print/install_lodop.exe";
        var strHtml1="<br><font color='blue'>打印控件未安装!点击这里<a href='"+http+"'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
